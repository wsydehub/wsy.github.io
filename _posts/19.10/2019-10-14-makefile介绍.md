...
layout:     post
title:      "makefile介绍"
subtitle:   "Introduce of makefile"
...
tags:
    ...
    - makefile
---
> Forwarded form <https://seisman.github.io/how-to-write-makefile/introduction.html>
## makefile介绍
...
注释。Makefile中只有行注释，和UNIX的Shell脚本一样，其注释是用 # 字符，这个就 像C/C++中的 // 一样。如果你要在你的Makefile中使用 # 字符，可以用反斜杠进行 转义，如： \# 。
...
如果目录 \<pref\>/include （一般是： /usr/local/bin 或 /usr/include ）存在的话，make也会去找。
